...
import instaIcon from "../images/icon_insta.png"; // 인스타 이미지
import youtubeIcon from "../images/icon_youtube.png"; // 유튜브 이미지
import facebookIcon from "../images/icon_facebook.png"; // 페이스북 이미지
import githubIcon from "../images/icon_github.png"; // 페이스북 이미지
        ...
        <div className="footer_second_container">
          ...
          <div className="github_box">
            ...
            <div className="github_item">
              <a
                href="https://github.com/jyh4897/shop.git"
                target="_blank"
              >
